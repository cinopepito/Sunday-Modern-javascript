...
let index = Math.floor(Math.random() * countries_data.length);
let country = countries_data[index];
...
imageP.src = country.flag;
populationP.textContent = country.population;
nameP.textContent = country.name;
capitalP.textContent = country.capital;
wrapper.appendChild(nameP);
wrapper.appendChild(capitalP);
wrapper.appendChild(populationP);
wrapper.appendChild(imageP);
